...
<div class="accordion accordion-rcpro" id="authAppInfoAccordion">
    <div class="accordion-item">
        <h2 class="accordion-header" id="authAppHeading1">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#authAppInfoStep1"
                aria-expanded="true" aria-controls="authAppInfoStep1">
                <strong>
                    <?= $module->framework->tt('mfa_info3') ?>
                </strong>
            </button>
        </h2>
        <div id="authAppInfoStep1" class="accordion-collapse collapse show" aria-labelledby="authAppHeading1"
                    ...
                    <li>
                        ...
                        <ul>
                            <li><img style="width: 2rem;"
                                    src="<?= $module->framework->getUrl('images/ga.webp', true) ?>"> <strong>
                                    <?= $module->framework->tt('mfa_info20') ?>
                                </strong></li>
                            <li><img style="width: 2rem;"
                                    src="<?= $module->framework->getUrl('images/ma.webp', true) ?>"> <strong>
    ...
    <div class="accordion-item">
        <h2 class="accordion-header" id="authAppHeading2">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                data-bs-target="#authAppInfoStep2" aria-expanded="false" aria-controls="authAppInfoStep2">
                <strong>
            ...
            <div class="accordion-body">
                <div class="row align-items-center">
                        ...
                        <div class="border border-rcpro p-2 rounded" style="font-size:small">
                            ...
                            <ul>
                                <li><span>
                                    ...
                                    </span> <strong><span id="authAppAccountName">
                                            <?= $module->framework->escape($rcpro_username) ?>
                                        </span></strong></span></li>
                                <li><span>
                                        <?= $module->framework->tt('mfa_info13') ?>
                                    </span> <strong><span id="authAppAccountKey">
                                            <?= $module->framework->escape($mfa_secret) ?>
                                        </span></strong></span></li>
                                <li><span>
                    ...
                    <div class="col text-center">
                        ...
                        <a id="authenticatorAppUrl" href="<?= $url ?>" target="_blank" rel="noopener noreferer">
    ...
    <div class="accordion-item">
        <h2 class="accordion-header" id="authAppHeading3">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                aria-labelledby="authAppHeading3" data-bs-target="#authAppInfoStep3" aria-expanded="false"
                aria-controls="authAppInfoStep3">
                <strong>
