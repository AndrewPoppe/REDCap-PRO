...
| **Allow Project-Level Language Manager**                                           | Checkbox | If enabled, project managers and administrators can manage languages within the project Settings tab — including activating/deactivating built-in languages, adding custom project translations, copying and editing translations, and downloading language files. If disabled, only the default language dropdown is shown in project settings. REDCap administrators always have access to the language manager regardless of this setting. See [Project Language Manager](#project-language-manager). | Unchecked |
...
| Setting                                                             |       Type       | Description                                                                                                                                                                                                                                                                |            Default Value             |
| :------------------------------------------------------------------ | :--------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------: |
| **Language**                                                        |     Dropdown     | The language that participant-facing text in the module will appear in. This overrides the default system setting. See the [Translation / Multi-Language Management](#translation--multi-language-management) section for more information. The full Language Manager (activate/deactivate languages, add custom translations, etc.) is only visible when **Allow Project-Level Language Manager** is enabled at the system level.                                                                                       |               English                |
